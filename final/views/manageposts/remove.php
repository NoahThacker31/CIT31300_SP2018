...
<div class="container">
	...
	<sub>
		<?php echo 'Posted on ' . date_format(date_create($date), 'j M Y') . ' by <a href="'.BASE_URL.'members/view/'. $uid.'">'. $first_name . ' ' . $last_name . '</a> in <a href="'.BASE_URL.'category/view/'. $categoryid.'">' . $name .'</a>'; ?>
	</sub>

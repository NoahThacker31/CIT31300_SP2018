		...
		<li id="add-cat-form-li">
			<form class="add-category-form" method="post" action="<?php echo BASE_URL; ?>category/add_category">
				<ul class="cat-add" style="list-style-type: none;">
					<li style="display: inline-block;"><input name="name" type="text" style="width: 186px" id="add-input" placeholder="Add a New category" /></li>
					<li style="display: inline-block;"><button type="submit" class="btn-sm btn-default cat-add">Submit</button></li>
				</ul>
			</form>
		</li>
	</ul>

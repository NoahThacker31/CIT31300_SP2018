...
<div class="container">
	...
	<?php foreach($users as $s){?>
		<div class="container">
			<h3>
				<?php echo $s['email'];?><br/><?php echo strval($s['first_name'].' '.$s['last_name'])?><br/>
			</h3>
			<p>
				<h4>User Type: </h4>
				<b>
			...
			<div class="container">
				<?php if ($s['active'] != '1') { ?>
					<a class="btn btn-success" href="<?php echo BASE_URL;?>manageusers/approve_user/<?php echo $s['uID'];?>">Approve</a>
				<?php } ?>
